...
const NAV: { section: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { code: "RP", href: "/organization/rate-plans", label: "Rate Plans", roles: ["admin"] },
      { code: "RX", href: "/organization/restrictions", label: "Restrictions", roles: ["admin"] },
      { code: "CH", href: "/organization/channels", label: "Channels", roles: ["admin"] },
